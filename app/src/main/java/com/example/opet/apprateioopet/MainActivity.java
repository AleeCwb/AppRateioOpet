...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkServico.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                //Toast.makeText(context: MainActivity.this, String.valueOf(isChecked),                Toast.LENGHT_SHORT.show());

                double comanda = Double.parseDouble(editComanda.getText.toString());
                comanda *= 1.1;
                editComanda.setText(new DecimalFormat( pattern " .00").format(comanda));
    ...
    public void calculaRateio(View view) {
        ...
        DecimalFormat mFormat = new DecimalFormat( pattern: ".00");
